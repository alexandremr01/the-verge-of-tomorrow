...
class Tiles:
    ...
    def __init__(self):
        ...
        self.structures = {0: Tile("CHECKERED_BASIC_1",
                                   Sprite((0, 0), graphics_dict["map"].get_image(11, (50, 50)))),
                           1: Tile("CHECKERED_BASIC_2",
                                   Sprite((0, 0), graphics_dict["map"].get_image(4, (50, 50)))),
                           2: Tile("CHECKERED_BASIC_3",
                                   Sprite((0, 0), graphics_dict["map"].get_image(12, (50, 50)))),
                           3: Tile("WALL_LEFT_RIGHT",
                                   Sprite((0, 0), graphics_dict["map"].get_image(25, (50, 50))), False),
                           4: Tile("WALL_TOP_BOTTOM",
                                   Sprite((0, 0), graphics_dict["map"].get_image(25, (50, 50)), 90), False),
                           5: Tile("WALL_LEFT_TOP",
                                   Sprite((0, 0), graphics_dict["map"].get_image(33, (50, 50)), -90), False),
                           6: Tile("WALL_LEFT_BOTTOM",
                                   Sprite((0, 0), graphics_dict["map"].get_image(33, (50, 50)))),
                           7: Tile("WALL_RIGHT_TOP",
                                   Sprite((0, 0), graphics_dict["map"].get_image(25, (50, 50)), -180), False),
                           8: Tile("WALL_RIGHT_BOTTOM",
                                   Sprite((0, 0), graphics_dict["map"].get_image(25, (50, 50)), 90), False),
                           9: Tile("WALL_PILLAR",
