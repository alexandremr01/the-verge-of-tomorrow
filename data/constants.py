...
CHUNK_RECT = pygame.Rect((0, 0), (CHUNK_SIZE, CHUNK_SIZE))
TOP_RECT = pygame.Rect((0, 0), (CHUNK_SIZE, CHUNK_SIZE/3))
BOTTOM_RECT = pygame.Rect((0, CHUNK_SIZE*2/3), (CHUNK_SIZE, CHUNK_SIZE/3))
LEFT_RECT = pygame.Rect((0, 0), (CHUNK_SIZE/3, CHUNK_SIZE))
RIGHT_RECT = pygame.Rect((CHUNK_SIZE*2/3, 0), (CHUNK_SIZE/3, CHUNK_SIZE))
